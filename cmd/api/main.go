...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "a575eacfe9a755", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "835f8495f631a7", "SMTP password")
